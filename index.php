...
<body>
      ...
      <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
                ...
                <!--      <img src="images/logo.jpg"  width="15% "/> --> Pet Adoption System</h4></a>
                </div>
        ...
        <div class="col-md-3" >
            ...
            <div class="panel panel-default wow fadeInDown">
              ...
              <ul class="list-group">
                ...
                <li class="list-group-item wow fadeInDown">Dog - <span style="color:#8B8B00; font-weight:bold;">From 500 to 600 </span> <span style="color:#EE5C42;" class="glyphicon glyphicon-ok pull-right"></span></li>
                 <li class="list-group-item wow fadeInDown">Fish  - <span style="color:#8B8B00; font-weight:bold;">From 150 to 300 </span> <span style="color:#EE5C42;" class="glyphicon glyphicon-ok pull-right"></span></li>
                  <li class="list-group-item wow fadeInDown">Bird  - <span style="color:#8B8B00; font-weight:bold;">From 300 to 450 </span> <span style="color:#EE5C42;" class="glyphicon glyphicon-ok pull-right"></span></li>
                  
                   <li class="list-group-item wow fadeInDown">Cat- <span style="color:#8B8B00; font-weight:bold;">From 200 to 350 </span> <span style="color:#EE5C42;" class="glyphicon glyphicon-ok pull-right"></span></li>
...
<footer id="footer" class="midnight-blue wow fadeInDown">
        <div class="container">
            <div class="row">
               ...
               &copy; 2021 <a target="_blank" href="#" title="#">Pet Adoption Website</a>. All Rights Reserved (Pet Farms).
                </div>
                <div class="col-sm-6">
